      ...
      <div className="navbar bg-base-100 p-5">
        ...
        <div className="navbar-end">
          <div className="icon-container ">
            <Link to={"/"} className="font-sans hover:text-orange-500 duration-300 ">
              Home
            </Link>
            <Link to={"/courses"} className=" font-sans hover:text-orange-500 duration-300 ">
              Courses
            </Link>
            <Link to={"/"} className=" font-sans hover:text-orange-500 duration-300  ">
              About
          ...
          <div className="btn-container">
            <Link to={"/signUp"} className="btn btn-ghost font-sans">
              Create Account
            </Link>
            <Link to={"/signIn"} className="btn font-sans">
              Sign In
            </Link>
          </div>
        </div>
