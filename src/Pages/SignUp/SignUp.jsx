          ...
          <div class="md:flex w-full">
            ...
            <div class=" w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div class="flex justify-between items-center gap-5 w-[648px] mx-auto">
                <button class="block w-full max-w-xs mx-auto  items-center flex border  focus:border-indigo-700  text-white text-sm rounded-sm  font-semibold">
                  <svg
                    className="mx-5"
                ...
                <button class="block w-full max-w-xs mx-auto  items-center flex border  focus:border-indigo-700 text-white text-sm rounded-sm  font-semibold">
                  ...
                  <span className="text-gray-900 border-l focus:border-indigo-700 py-3 ps-14"> Apple</span>
                </button>
              </div>
            </div>
          </div>
