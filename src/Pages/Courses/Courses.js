...
const filters = [
  {
    categories: [
      { category_name: "web development", number: 574 },
      { category_name: "Data Science", number: 568 },
      { category_name: "Mobile Development", number: 1345 },
      { category_name: "Software Testing", number: 317 },
      { category_name: "Software Engineering", number: 31 },
      { category_name: "Sof. Development Tools", number: 548 },
      { category_name: "No-Code Development", number: 58 },
      { category_name: "Business", number: 574 },
      { category_name: "Finance & Accounting", number: 674 },
      { category_name: "It & Software", number: 154 },
      { category_name: "Office Productivity", number: 364 },
      { category_name: "Personal Development", number: 974 },
      { category_name: "Design", number: 454 },
      { category_name: "Marketing", number: 341 },
      { category_name: "LifeStyle", number: 597 },
      { category_name: "Photography & Video", number: 505 },
      { category_name: "Music", number: 313 },
      { category_name: "Health & Fitness", number: 504 },
    ],
    ...
    <div>
            ...
            <>
              <div>
                <div className=" w-[15.25rem] h-[19.938rem] bg-base-100 shadow-xl">
                  <div>
                    <img
                      className="w-[15.25rem] h-[11.438rem]"
                      src={bestCourse.cover_image}
                      alt="Shoes"
                    />
                  </div>
                  <div>
                    <div className="flex justify-between items-center px-[0.875rem] pt-[0.875rem] ">
                      <h2
                        ...
                        style={{
                          color: `${bestCourse.color}`,
                          background: `${bestCourse.background}`,
                        }}
                      >
                        {bestCourse.category}
                      </h2>
                      <h2 className="text-[#FF6636] font-semibold text-[1rem]">
                        ${bestCourse.price}
                      </h2>
                    </div>
      ...
      <div>
        <div className="w-[82rem] mx-auto flex justify-between items-center px-1 pt-[5rem]">
          <span className="text-[2rem] text-[#1d2026] font-sans font-semibold">
            Popular tools
          </span>
        ...
        <div className="flex  items-center w-[82.5rem] mx-auto gap-5 py-[1.5rem]">
          <div className="text-[1.125rem] font-semibold capitalize">
            popular Search :
          </div>
            ...
            <>
              ...
              <div>
                <div className=" w-[15.25rem] h-[22.625rem] bg-base-100 shadow-xl">
                  <div>
                    <img
                      className="w-[15.25rem] h-[15.25rem]"
      ...
      <div>
        <div className="filters_header mt-[7rem]  ">
          <div className="w-[1320px] px-2 mx-auto flex items-center justify-between ">
            <div className="flex items-center gap-[1.5rem]">
              <button className="btn gap-3 bg-white hover:bg-white  text-orange-500 px-5 border-orange-500 rounded-none">
                ...
                <span className="border-orange-500 bg-orange-500 text-white p-1 ms-3  ">
                  3
                </span>
              </button>
              {/* <!-- search input --> */}
        ...
        <div className="border-b w-[1320px] my-4 py-1 flex items-center justify-between mx-auto">
          <h1 className=" font-semibold">
            Total Items :
            <span className="text-orange-500 px-1 font-sans font-semibold ">
              100
            </span>
            courses
          </h1>
          <h1 className="font-semibold text-orange-500">
            <span className="text-indigo-500 font-sans ">3,145,684</span>
            results find for “ui/ux design”
          </h1>
        </div>
      </div>

      <div className="flex justify-between  gap-3 w-[82.5rem] mx-auto">
        <div className="">
          <h1 className="text-indigo-500 border font-semibold p-3 ">
            Category
          </h1>
              ...
              <>
                <h1>
                  {filter.categories.map((item) => (
                    <div className="flex justify-between items-center gap-20  border-b p-2">
                      <h1 className="font-sans font-semibold text-[14px] flex gap-1 items-center ">
                        <input type="checkbox" name="" id="" />
                        {item.category_name}
                      </h1>
                      <h1 className="font-sans font-semibold text-[14px] flex gap-1 items-center text-[#8C94A3] ">
                        {item.number}
                      </h1>
                    </div>
                  ))}
          ...
          <div className="" >
            <h1 className=" border p-2  font-sans text-[#000] text-[18px] mt-5">
              Popular Tools
            </h1>
            {popularTools.map((item) => (
              <>
                <div className="flex justify-between items-center gap-20 border-b border-r border-l p-2">
                  <h1 className="font-sans font-semibold text-[14px] flex gap-1 items-center ">
                    <input type="checkbox" name="" id="" />
                    {item.name}
                  </h1>
